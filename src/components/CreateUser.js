...
export default function CreateUser() {
    ...
    const onAmountChange = (e) => {
        ...
        if (amount <= 50000) {
            ...
            setAmountHelper('Depost Limit 50000')
        }
    ...
    const Push = (e) => {
        ...
        if (name.length === 0 ||
            ...
            setAlertMesssage("Invalid Details! Enter The details Again");
        }
                ...
                <Grid item container direction='column' style={{ alignItems: 'center' }}>
                    ...
                    >
                        <Grid item style={{ marginTop: '2em', marginBottom: '0.5em' }}>
                            <Typography style={{ color: theme.palette.common.blue }}>Account Holder Name</Typography>
                            <TextField
                                id="name"
                                variant="outlined"
                                fullWidth
                        ...
                        <Grid item style={{ marginBottom: '0.5em' }}>
                            <Typography style={{ color: theme.palette.common.blue }}>Deposit Amount </Typography>
                            <TextField
                                id="amount"
                                variant="outlined"
                                fullWidth
