...
export default function Transfer() {
  ...
  const transferMoney = async (e) => {
    ...
    if (reciver.length === 0 ||
      ...
      setAlertMesssage("Eneter Valid Details");
      if (amt > 25000)
        setAmountHelper('Transfer Limit 25000');
      else {
        setAmountHelper('');
      }
      return
        ...
        <Grid item container direction='column' style={{ alignItems: 'center' }}>
          ...
          >
            <Grid item style={{ marginTop: '2em', marginBottom: '0.5em' }}>
              <Typography style={{ color: theme.palette.common.blue }}>From Account</Typography>
            ...
            <Grid item style={{ marginBottom: '0.5em' }}>
              <Typography style={{ color: theme.palette.common.blue }}>beneficiary Account</Typography>
              <FormControl variant="outlined" fullWidth >
                <Select
                  native
                  value={reciver}
